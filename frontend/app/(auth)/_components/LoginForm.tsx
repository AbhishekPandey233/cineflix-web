...
export default function LoginForm() {
  ...
  return (
    <div className="space-y-5">
      {status && (
        <div
          className={`rounded-md border px-3 py-2 text-xs ${status.type === "success" ? "border-emerald-400/30 bg-emerald-400/10 text-emerald-200" : "border-red-500/30 bg-red-500/10 text-red-200"}`}
        >
          {status.text}
        </div>
      )}
